                  ...
                  return (
                    <tr key={p.id} className={`hover:bg-gray-50 transition ${i % 2 === 1 ? 'bg-[#FAFAFA]' : ''}`}>
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center whitespace-nowrap text-[11px] sm:text-xs xl:text-[10px] 2xl:text-xs leading-none font-semibold px-2 sm:px-2.5 xl:px-1.5 2xl:px-2.5 py-1 rounded-full ${statusBadge(p.status)}`}>
                          {p.status.replace('_', ' ')}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`inline-flex items-center whitespace-nowrap text-[11px] sm:text-xs xl:text-[10px] 2xl:text-xs leading-none font-semibold px-2 sm:px-2.5 xl:px-1.5 2xl:px-2.5 py-1 rounded-full ${planLabelColor}`}>
                            {planLabel}
                          </span>
                        </div>
                        {!profilePayment && (
