...
const InfoRow = ({
    ...
    <div className="flex justify-between items-center py-[6px]">
        <span className="text-[13px] md:text-[14px] lg:text-[15px] 2xl:text-[16px] text-[#010806A1]/65 font-poppins">{label}</span>
        <span className="text-[13px] md:text-[14px] lg:text-[15px] 2xl:text-[16px] font-medium text-[#010806CC]/80 font-poppins text-right  truncate">
            {value}
        </span>
    </div>
);
    ...
    return (
        <div className="relative bg-white rounded-[20px] shadow-[0_4px_24px_rgba(0,0,0,0.10)] w-full flex-shrink-0 overflow-visible pt-4 pb-5 px-4">
            ...
            <div className="absolute top-3 right-3 z-10">
                <span className="flex items-center gap-1 bg-white border border-gray-200 rounded-full px-2.5 py-0.5 text-[11px] md:text-[13px] lg:text-[15px] 2xl:text-[16px] font-medium text-gray-600 font-poppins shadow-sm">
            ...
            <div className="relative w-[110px] h-[110px] mx-auto mt-2 mb-3">
                ...
                {/* Verified badge */}
                {isVerified && (
                    <div className="absolute bottom-1 right-1 w-6 h-6 z-10">
                        <VerifiedIcon />
                    </div>
                )}
            </div>
